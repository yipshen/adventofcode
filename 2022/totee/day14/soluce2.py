    ...
    with open(inputFile,'r') as f:
        for line in f:
            ...
            for e in l[1:]:
                ...
                previous = e
    # add floor
    matrice_line, matrice_col = matrice.shape
    print(f"lig: {matrice_line} , col: {matrice_col}")
    for i in range(matrice_col):
        matrice[matrice_line-1, i] = '#'
    return matrice
...
def main():
    ...
    padding_border = 800
    minCol = minCol - padding_border

    maxLig = maxLig + 3 # add floor

    # allocate matrice
    # 3 corresponding to the floor and 20 correspond of infinity
    map = initMatrice(maxLig, (maxCol - minCol) + padding_border)
    ...
    print(f'toto : {getElementMap(map,sandInit,minCol)}')
        ...
        for event in event_list:  # On parcours la liste de tous les événements reçus
            ...
            if event.type == pygame.KEYDOWN:
                ...
                if event.key == pygame.K_a:
                    ...
                    # print(map)
                    # time.sleep(1)
                    while (not isBlocked(map, sandCurrent, minCol)) and (sandCurrent[0] < maxLig):
                        ...
                        if isBlocked(map, sandCurrent, minCol):
                            ...
                            sandPath = []
                    # print(f"toto sandCurrent: {sandCurrent}")
                    if sandCurrent == sandInit:
